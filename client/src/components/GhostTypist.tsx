  ...
  return (
    <div className="min-h-screen p-4 flex flex-col items-center justify-between fade-in">
      ...
      <div className="text-center w-full py-4">
        <h1 className="text-2xl font-semibold text-primary">Ghost Typist Basic</h1>
      </div>

      {/* Score Display */}
      <div className="w-full mb-4">
        <div className="flex justify-between mb-2">
          <div className="text-sm font-medium text-primary">High Score: <span>{highScore}</span></div>
          <div className="text-sm font-medium text-primary">Time: <span>{gameTime}</span>s</div>
        </div>
        <div className="flex justify-between">
          <div className="text-sm font-medium text-primary">Current Score: <span>{currentScore}</span></div>
          <div className="text-sm font-medium text-primary">Level: <span>{currentLevel}</span></div>
        </div>
      </div>
      ...
      <div className="flex-grow flex flex-col items-center justify-center w-full">
        ...
        <div className="flex justify-center items-center mb-8">
          <GhostIcon className="w-32 h-32 opacity-90" />
        </div>

        {/* Word Display */}
        <div className="mb-6 text-center">
          <div className="text-lg font-medium mb-2 text-primary">
            {gameState === 'playing' ? 'Type the word below to push back the ghost!' : 'Get ready to type!'}
          </div>
          <div className="text-2xl font-semibold mb-6 text-primary">{currentWord}</div>
        </div>
        ...
        {gameState === 'gameOver' && (
          <div className="text-center fade-in">
            <h2 className="text-xl font-semibold mb-2 text-primary">Game Over!</h2>
      ...
      <div className="mt-auto w-full text-center py-4">
        <p className="text-xs text-primary opacity-70">Ghost Typist Basic | Type to survive!</p>
      </div>
    </div>
  );
}
